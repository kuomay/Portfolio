<template>
    <div class="flex flex-row mt-16 mb-16 p-6 w-3/5 h-90 mx-auto bg-white rounded-xl shadow-lg items-center space-x-4">
      <a href="https://maxs-fer.geosat.com.tw/" target="_blank" rel="noopener noreferrer">
        <img src="/assets/013 2024-06-21 185608.png" alt="">
      </a>
      <div>
        ...
        <p class="text-slate-500">該平台提供有關無人機飛行員培訓、考試細節和線上模擬考試的資訊。</p>
        <a class="mt-3" href="https://maxs-fer.geosat.com.tw/" target="_blank">https://maxs-fer.geosat.com.tw/</a>
      </div>
    </div>
</template>
